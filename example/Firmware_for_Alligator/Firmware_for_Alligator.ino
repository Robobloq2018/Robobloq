 ...
 *           5.1.6             2018/07/27         Allen                      增加鳄鱼、恐龙固件
 *           5.1.6             2018/07/27         Allen                      修复数据
 *********************************************/
        ...
        switch(Work_Mode)
           {
              case Remote_Control_Mode:
                      SensorType_Update(); 
                      break;
              case Alligator_Ultrasonic_Mode:
                      Alligator_UltrCarProcess();
                      break;
             case Dinosaur_Ultrasonic_Mode:
                      Dinosaur_UltrCarProcess();
                      break;
            }
 ...
 * 
 */
void Dinosaur_UltrCarProcess(void)
{    
...
void Alligator_UltrCarProcess(void)
{    
    static   unsigned char flag  = 0;
    static   unsigned char last_flag = 0;
    uint8_t randnum;
